/**
 * GET /api/cron/pending-checkins?week=YYYY-Www
 * Lista clientes ativos COM credenciais Meta que ainda não têm checkin
 * gravado pra semana informada (consulta weekly_checkins).
 * Consumido pelo checkin-poller.sh local — segunda 11h BRT.
 *
 * Padrão idêntico ao /api/cron/pending-analyses (mesma assinatura de resposta).
 */
...
export async function GET(req: NextRequest) {
  ...
  // Checkin precisa de credenciais Meta — sem token não há o que comparar
